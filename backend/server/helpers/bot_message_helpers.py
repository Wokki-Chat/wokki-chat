...
from server.helpers.server_helpers import get_server_channel_sids
...
async def embed_button(sid, metadata, data):
    ...
    if not all([bot_id, button_id, server_id, channel_id]):

...
<head>
    ...
    <title>wokkichat.types API documentation</title>
  ...
  <path fill-rule="evenodd" d="M4.146 8.354a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5H14.5a.5.5 0 0 1 0 1H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3z"/>
    ...
    <?php echo $sidebar; ?>
            ...
            <h2>API Documentation</h2>
                <ul class="memberlist">
            <li>
                    <a class="variable" href="#UserId">UserId</a>
            </li>
            <li>
                    <a class="variable" href="#JSON">JSON</a>
            </li>
    </ul>
...
<div class="header">
    ...
    <main class="pdoc">
            <section class="module-info">
                        <a class="pdoc-button git-button" href="https://github.com/levkris/Wokki-Chat-Python-SDK/tree/main/wokkichat/types.py">Edit on GitHub</a>
                    <h1 class="modulename">
<a href="./../wokkichat.html">wokkichat</a><wbr>.types    </h1>
                        ...
                        <div class="pdoc-code codehilite"><pre><span></span><span id="L-1"><a href="#L-1"><span class="linenos">1</span></a><span class="kn">from</span><span class="w"> </span><span class="nn">typing</span><span class="w"> </span><span class="kn">import</span> <span class="n">Any</span><span class="p">,</span> <span class="n">Dict</span><span class="p">,</span> <span class="n">Union</span>
</span><span id="L-2"><a href="#L-2"><span class="linenos">2</span></a>
</span><span id="L-3"><a href="#L-3"><span class="linenos">3</span></a><span class="n">UserId</span> <span class="o">=</span> <span class="n">Union</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="nb">int</span><span class="p">]</span>
</span><span id="L-4"><a href="#L-4"><span class="linenos">4</span></a><span class="n">JSON</span> <span class="o">=</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Any</span><span class="p">]</span>
</span></pre></div>
...
<span class="default_value">typing.Union[str, int]</span>

        
    </div>
    <a class="headerlink" href="#UserId"></a>
...
<span class="default_value">typing.Dict[str, typing.Any]</span>
    ...
    <a class="headerlink" href="#JSON"></a>

...
<body>
    ...
    <main id="app">
        ...
        <wchat-data id="server-name" value="<?php echo htmlspecialchars($serverInfo['server_name']); ?>"></wchat-data>
        <wchat-data id="server-description" value="<?php echo htmlspecialchars($serverInfo['server_description']); ?>"></wchat-data>
    </main>
